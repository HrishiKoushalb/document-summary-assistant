    ...
    <div className="w-full">
      <button
        ...
        className={[
          ...
          isDragOver
            ? 'border-mark bg-mark/[0.06] scale-[1.01]'
            : 'border-ink-line bg-ink-soft hover:border-ink-text-muted hover:bg-ink-soft/80',
        ].join(' ')}
      >
        <input
          ref={inputRef}
        ...
        <div
          className={[
            ...
            isDragOver ? 'border-mark bg-mark text-ink' : 'border-ink-line bg-ink text-mark',
          ].join(' ')}
        >
        ...
        <div>
          <p className="font-display text-xl sm:text-2xl text-ink-text">
        ...
        <div className="mt-2 flex items-center gap-4 font-mono text-[11px] uppercase tracking-wider text-ink-text-muted">
